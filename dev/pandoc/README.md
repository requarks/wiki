...
## to Build and push docker image to nexus
 ...
 ```
  docker login docker-registry-pt-support-shared.pl.s2-eu.capgemini.com

  docker build -t docker-registry-pt-support-shared.pl.s2-eu.capgemini.com/mar/pandoc:latest-dev . --no-cache

  docker push docker-registry-pt-support-shared.pl.s2-eu.capgemini.com/mar/pandoc:<image-tag> 

 ```
  above use <image-tag> = latest-dev for dev or staging or use <image-tag> = latest for prod