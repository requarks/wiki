        ...
        .admin-header
          ...
          .admin-header-title
            ...
            .subtitle-1.grey--text.animated.fadeInLeft.wait-p2s
              ...
              span /{{page.siteId}}/{{page.locale}}/{{page.path}}
          v-spacer
          ...
          v-menu(offset-y, origin='top right')
            ...
            v-list(dense, nav)
              v-list-item(:href='`/` + page.siteId + `/` + page.locale + `/` + page.path')
                v-list-item-icon
                  v-icon(color='indigo') mdi-text-subject
                v-list-item-title View
              v-list-item(:href='`/e/` + page.siteId + `/` + page.locale + `/` + page.path')
                v-list-item-icon
              ...
              v-list-item(:href='`/s/` + page.siteId + `/` + page.locale + `/` + page.path')
                v-list-item-icon
                  v-icon(color='indigo') mdi-code-tags
                v-list-item-title View Source
              v-list-item(:href='`/h/` + page.siteId + `/` + page.locale + `/` + page.path')
                v-list-item-icon
