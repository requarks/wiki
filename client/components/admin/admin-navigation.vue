                    ...
                    v-card(flat, style='border-radius: 0 4px 4px 0;')
                      template(v-if='current.kind === "link"')
                        ...
                        v-card-text
                          ...
                          .caption.pl-5 Refer to the #[a(href='https://pictogrammers.com/', target='_blank') Material Design Icon Library] for the list of all possible values. You must prefix all values with #[code mdi-], e.g. #[code mdi-home]
