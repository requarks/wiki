...
mkdir -p "${BASE_PATH:?err}/grafana/data/${ENVIRONMENT}"
mkdir -p "${BASE_PATH:?err}/grafana/config/${ENVIRONMENT}"
mkdir -p "${BASE_PATH:?err}/prometheus/data/${ENVIRONMENT}"
mkdir -p "${BASE_PATH:?err}/prometheus/config/${ENVIRONMENT}"
mkdir -p "${BASE_PATH:?err}/loki/config/${ENVIRONMENT}"
mkdir -p "${BASE_PATH:?err}/loki/data/${ENVIRONMENT}"
mkdir -p "${BASE_PATH:?err}/promtail/config/${ENVIRONMENT}"
